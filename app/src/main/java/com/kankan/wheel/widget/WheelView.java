...
public class WheelView extends View {
    ...
    private int n;
    private kankan.wheel.widget.apps.e o;
    private kankan.wheel.widget.f p = new f(this);
    private List<kankan.wheel.widget.b> q = new LinkedList();
    private List<kankan.wheel.widget.d> r = new LinkedList();
    private List<kankan.wheel.widget.c> s = new LinkedList();
    ...
    private boolean c(int var1) {
        kankan.wheel.widget.apps.e var2 = this.o;
        boolean var3;
    ...
    protected void a(int var1) {
        ...
        while(var2.hasNext()) {
            ((kankan.wheel.widget.c)var2.next()).a(this, var1);
        }
    ...
    protected void a(int var1, int var2) {
        ...
        while(var3.hasNext()) {
            ((kankan.wheel.widget.b)var3.next()).a(this, var1, var2);
        }
    ...
    public void a(int var1, boolean var2) {
        kankan.wheel.widget.apps.e var3 = this.o;
    ...
    public void a(kankan.wheel.widget.d var1) {
        this.r.add(var1);
    }
    ...
    protected void b() {
        ...
        while(var1.hasNext()) {
            ((kankan.wheel.widget.d)var1.next()).a(this);
        }
    ...
    protected void c() {
        ...
        while(var1.hasNext()) {
            ((kankan.wheel.widget.d)var1.next()).b(this);
        }
    ...
    public kankan.wheel.widget.apps.e getViewAdapter() {
        return this.o;
    }
    ...
    public void setViewAdapter(kankan.wheel.widget.apps.e var1) {
        kankan.wheel.widget.apps.e var2 = this.o;
        if (var2 != null) {
