...
object MimeTypes {
    ...
    const val MIME_MSOFFICE_OOXML_WORD_DOCUMENT_TEMPLATE =
        "application/vnd.openxmlformats-officedocument.wordprocessingml.template"
    const val MICROSOFT_WORD_MACRO_ENABLED_TEMPLATE =
    ...
    const val MIME_MICROSOFT_EXCEL_ADD_IN_FILE = "application/vnd.ms-excel.addin.macroEnabled.12"
    const val MIME_MICROSOFT_EXCEL_BINARY_WORKBOOK =
        "application/vnd.ms-excel.sheet.binary.macroEnabled.12"
    const val MIME_MICROSOFT_EXCEL_MACRO_ENABLED_WORKBOOK =
        "application/vnd.ms-excel.sheet.macroEnabled.12"
    const val MIME_MICROSOFT_EXCEL_MACRO_ENABLED_TEMPLATE_FILE =
        "application/vnd.ms-excel.template.macroEnabled.12"
    const val MIME_MICROSOFT_OFFICE_OOXML_SPREADSHEET_TEMPLATE =
        "application/vnd.openxmlformats-officedocument.spreadsheetml.template"
    const val MIME_APPLICATION_VND_MSEXCEL_2007 =
        "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
    const val MIME_APPLICATION_VND_SPREADSHEET = "application/vnd.oasis.opendocument.spreadsheet"
    const val MIME_APPLICATION_VND_MSPOWERPOINT = "application/vnd.ms-powerpoint"
    const val MIME_APPLICATION_POWERPOINT = "application/powerpoint"
    const val MIME_MICROSOFT_POWERPOINT_MACRO_ENABLED_TEMPLATE_FILE =
        "application/vnd.ms-powerpoint.template.macroenabled.12"
    const val MIME_MICROSOFT_POWERPOINT_MACRO_ENABLED_SLIDE_SHOW_FILE =
        "application/vnd.ms-powerpoint.slideshow.macroenabled.12"
    const val MIME_MICROSOFT_OFFICE_OOXML_PRESENTATION =
    ...
    init {
        extMapping = object : HashMap<String, String>(200) {
            private fun put1(key: String, value: String) {
                require(put(key, value) == null) { "Duplicated Mimetype: $key" }
            }
            ...
            init {
                ...
                put(MIME_MSOFFICE_OOXML_WORD_DOCUMENT_TEMPLATE, ".dotx")
                put1(MICROSOFT_WORD_MACRO_ENABLED_TEMPLATE, ".dotm")
                put1(MIME_MICROSOFT_EXCEL_ADD_IN_FILE, ".xlam")
                put1(MIME_MICROSOFT_EXCEL_BINARY_WORKBOOK, ".xlsb")
                put1(MIME_MICROSOFT_EXCEL_MACRO_ENABLED_WORKBOOK, ".xlsm")
                put1(MIME_MICROSOFT_EXCEL_MACRO_ENABLED_TEMPLATE_FILE, ".xltm")
                put1(MIME_MICROSOFT_OFFICE_OOXML_SPREADSHEET_TEMPLATE, ".xltx")
                put1(MIME_APPLICATION_POWERPOINT, "ppt")
                put1(MIME_MICROSOFT_POWERPOINT_MACRO_ENABLED_TEMPLATE_FILE, ".potm")
                put1(MIME_MICROSOFT_POWERPOINT_MACRO_ENABLED_SLIDE_SHOW_FILE, "ppsm")
                put1(MIME_MICROSOFT_OFFICE_OOXML_PRESENTATION, ".pptx")
